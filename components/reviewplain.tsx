  ...
  return (
    ...
    >
      ...
      <CardContent>
        ...
        <Typography paragraph>
          Second, the managerial system works well in some cases but in my case,
          I worked under a manager who was a very privileged white woman. I
          constantly felt microaggressions during my time working there. Just
          because I was a BIPOC, three white managers would ask for my input on
          how to sell any book that mentions BIPOC without offending anyone and
          alienating the “larger audience.” The Black senior editor of Amistad
          (one of the Harpers imprints) was fired with no warning–this is very
          much indicative of what HarperCollins is: an unhealthy workplace for
          people from marginalized communities that at best practices
          performative allyship on the backs of its POC employees. It is an open
          secret that the current president and the execs are transphobic and
          extremely insensitive to racial issues. The anecdotes are
          overwhelming. I heard from other editorial assistants that a senior
          POC editor talked to them about how she doesn’t feel comfortable
          bringing in other POC women to [ ] because it is not a safe place.
        </Typography>
        <Typography paragraph>
